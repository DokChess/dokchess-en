...
public class PolyglotToolsTest {
    ...
    public void felderInZeichenketten() {
        ...
        String a1 = PolyglotTools.fileAndRankToString(0, 0);
        Assert.assertEquals("a1", a1);

        String h1 = PolyglotTools.fileAndRankToString(7, 0);
        Assert.assertEquals("h1", h1);

        String a8 = PolyglotTools.fileAndRankToString(0, 7);
        Assert.assertEquals("a8", a8);

        String h8 = PolyglotTools.fileAndRankToString(7, 7);
